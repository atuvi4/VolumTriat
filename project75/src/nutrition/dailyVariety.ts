...
const THEMES: Record<Theme, ThemeDef> = {
  ...
  yogurt: { keywords: ['iogurt', 'yogur', 'yogurt', 'grec', 'griego', 'greek', 'skyr'], foodIds: ['greek_yogurt', 'protein_yogurt', 'plain_yogurt'], warn: 'soft', label: 'iogurt', suggest: 'ous o fruita' },
